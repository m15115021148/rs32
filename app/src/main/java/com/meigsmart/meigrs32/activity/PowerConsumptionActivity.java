...
public class PowerConsumptionActivity extends BaseActivity implements View.OnClickListener,PromptDialog.OnPromptDialogCallBack  {
    private PowerConsumptionActivity mContext;
    @BindView(R.id.title)
    ...
    protected void initData() {
        ...
        mTitle.setText(R.string.pcba_power);
